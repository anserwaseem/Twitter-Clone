...
class Happening extends Component {
  ...
  render() {
    ...
    return (
      <Container className={`fitContent ${this.props?.reply && "ps-0"}`}>
        <Stack
          direction="horizontal"
          className={!this.props?.reply && "border-bottom"}
        >
          <Stack style={{ flex: "unset" }}>
            <div className="pe-3">
              <img
                src={require(`${this.state.dp}`)}
          ...
          <Stack>
            <div>
              <Form.Control
                size="lg"
                as="textarea"
                rows={this.props?.reply ? "3" : "1"}
                placeholder={this.props.text}
                className={`border-0 ${!this.props?.reply && "border-bottom"}`}
            ...
            <Stack direction="horizontal" className="justify-content-evenly">
              ...
              >
                {!this.props?.reply && (
                  <div
                    className="rounded-circle border border-2 ms-auto p-1 align-self-center"
                    // style={{
                ...
                <Button
                  ...
                  className="rounded-pill border-0 px-3 m-2"
                  style={{ backgroundColor: "rgb(29, 155, 240)" }}
                >
                  <strong>{this.props?.reply ? "reply" : "Tweet"}</strong>
                </Button>
              </Stack>
            </Stack>
          </Stack>
